...
3. 如何解决跨域问题，为什么要有同源限制?

   > 

4. 将一下浏览器history对象，或者问（vue/react）route的实现原理？
...
1. for in 和 for of的区别，Generator 怎么用？

   > 

2. for循环绑定onckick事件，点击拿下标（函数中this的指向问题）？
...
4. let与var和const的区别是什么？

   > 

5. 讲一下String Array Date方法有哪些？
...
3. 怎么给一个数组去重，尽量说多几种方法？

   > 

4. ...是深拷贝还是浅拷贝？说多几种深拷贝方法？

   > 

5. apply, call, bind三者的使用与区别 ?
...
1. 讲一下什么是闭包，作用域，和作用域链（区分一下原型链）？

   > 变量提升，js执行上下文

2. 讲一下DOM事件级别，事件流是什么，事件的冒泡与捕获？
...
4. 讲一下cookie和localSrorage 、session 、indexDB 的区别？
